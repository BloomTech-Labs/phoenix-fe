...
<Typography id="simple-modal-title" style={{ fontSize: '2rem'}}>Register</Typography>
<Typography id="simple-modal-description" style={{ fontSize: '1rem'}}>
...
variant="outlined"
/>
<Button variant="outlined" onSubmit={handleSubmit}>Register</Button>
</form>
</div>
</div>
</Modal>
